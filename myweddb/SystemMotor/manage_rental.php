...
<<<<<<< Updated upstream:myweddb/SystemMotor/manage_rental.php
...
=======
                ...
                price <= '$keyword' or firstname like '%$keyword%' or lastname like '%$keyword%' or date_get like '%$keyword%' 
>>>>>>> Stashed changes:myweddb/manage_rental.php
                or date_return like '%$keyword%' ORDER BY promise_id limit {$start}, {$perpage}";
            } else {
...
<<<<<<< Updated upstream:myweddb/SystemMotor/manage_rental.php
                        <td><a class="btn btn-outline-primary" href="del_promise.php?id=<?= $row['promise_id'] ?>" 
                        onclick="Return(this.href);return false;" title="ส่งคืนรถ"><i class="fa-solid fa-motorcycle"></i></a></td>
=======
